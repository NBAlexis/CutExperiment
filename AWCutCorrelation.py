...
testYjjSM = HistogramWithMinMax(testEventsm, LeptonPtFilter, [0, 2000], 50)
testYjjM2 = HistogramWithMinMax(testEventm2, LeptonPtFilter, [0, 2000], 50)
testYjjT5 = HistogramWithMinMax(testEventt5, LeptonPtFilter, [0, 2000], 50)
print(testYjjSM.listCount)
print(testYjjM2.listCount)
print(testYjjT5.listCount)
"""
