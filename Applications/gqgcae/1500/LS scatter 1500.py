...
dataFgT3originall = pd.read_csv('G:\科研\检测异常度\data\Features\FgT3-1500.csv')
...
test.to_csv('3TeVsmLS.csv') #数据存入csv,存储位置及文件名称
xFgT0 = pred_FgT0[:,0]
yFgT0 = pred_FgT0[:,1]
xFgT1 = pred_FgT1[:,0]
yFgT1 = pred_FgT1[:,1]
...
test.to_csv('3TeVnpLS.csv') #数据存入csv,存储位置及文件名称
print(x,y)
