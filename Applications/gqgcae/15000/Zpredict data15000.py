...
datatrainarrange = np.array(np.mean(datatrainoriginal,axis=0))
datatrainstd = np.array(np.std(datatrainoriginal,axis=0))
...
autoencoder30 = load_model("autoencoder30.h5")
datatrain = data[0:400000]
datavalidation = data[400000:500000]
datatest = data[500000:]
pred_test = autoencoder30.predict(datatest)
print('datatest')
print(datatest)
print('pred_test')
print(pred_test)
...
print('dataFgT0')
print(dataFgT0)
pred_FgT0 = autoencoder30.predict(dataFgT0)
print('pred_FgT0',pred_FgT0)
mse_test_pred_FgT0 = np.array(np.mean(np.power(dataFgT0 - pred_FgT0, 2), axis=1))
print('mse_test_pred_FgT0',mse_test_pred_FgT0)
...
pred_FgT1 = autoencoder30.predict(dataFgT1)
...
pred_FgT2 = autoencoder30.predict(dataFgT2)
...
pred_FgT3 = autoencoder30.predict(dataFgT3)
...
ε_test = n_mse_datatest/(312332*1000000/812332)
...
print(mse_n, n_mse_datatest, a, b0dth, b1dth, b2dth, b3dth)
