...
for collisionEvent in allEvents.events:
    ...
    oneCollisionData = collisionEvent.particles[jetids[0]].momentum.values
    oneCollisionData = oneCollisionData + collisionEvent.particles[jetids[1]].momentum.values
    oneCollisionData = oneCollisionData + collisionEvent.particles[photonids[0]].momentum.values
